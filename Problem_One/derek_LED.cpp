...
// Definition file for derek_LED.h

// This cpp file is used to define all of the functions listed in the
// derek_LED.h file. It goes through all of the functions for the LED class,
// including the constructor, writeLED, removeTrigger, turnOn, turnOff, flash,
// outputState, and the LED deconstructor.
...
LED::LED(int number){
  this->number = number;
  // mych easier with C++11 using to_string(number)
